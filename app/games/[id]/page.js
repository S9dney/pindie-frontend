...
export default function GamePage(props) {
 ...
 {game ? (
    ...
    <Preloader/>
        ...
        <section className={Styles['game']}>
            <img src="https://celes.club/uploads/posts/2022-10/thumbs/1666935856_6-celes-club-p-sobaka-ded-insaid-pinterest-6.jpg"></img>
            <p>доты тут нету..</p>
            <h4 className={Styles['dota']}>может и к лучшему....</h4>
        </section>
    )}
    </main>
  );
